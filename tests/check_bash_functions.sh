...
@test "check _find_git_estimator_ignored_dirs" {
  ...
  run f
  assert_success
  expected="-not -path '*/ugly_glob/*' -not -path '*/*.egg-info/*' -not -path '*/*.manifest/*' -not -path '*/*.py[cod]/*' -not -path '*/data_stuff/*' -not -path '*/.Python/*' -not -path '*/.cache/*' -not -path '*/.coverage/*' -not -path '*/.eggs/*' -not -path '*/.fake/*' -not -path '*/.hypothesis/*' -not -path '*/.ionide/*' -not -path '*/.ipynb_checkpoints/*' -not -path '*/.python-version/*' -not -path '*/.tox/*' -not -path '*/__pycache__/*' -not -path '*/build/*' -not -path '*/data/*' -not -path '*/develop-eggs/*' -not -path '*/dist/*' -not -path '*/docs/_build/*' -not -path '*/downloads/*' -not -path '*/eggs/*' -not -path '*/env/*' -not -path '*/htmlcov/*' -not -path '*/lib/*' -not -path '*/lib64/*' -not -path '*/pandas_data_analytics/wine/data/*' -not -path '*/parts/*' -not -path '*/pwd/*' -not -path '*/rm/*' -not -path '*/-rf/*' -not -path '*/test/area/that/should/not/exist/*' -not -path '*/sdist/*' -not -path '*/target/*' -not -path '*/var/*' -not -path '*/.git/*' -not -path '*/.svn/*'"
