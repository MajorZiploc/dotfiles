...
vsc_settings_destination_placeholder="$HOME/Library/Application Support/Code/User/";
...
find -E "$tempShared" -iregex ".*alias.*bash.*" -type f -exec gsed -E -i'' "s/\bsed\b/gsed/g" {} \;
