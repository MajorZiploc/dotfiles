...
find "$SCRIPTPATH/../../../shared/" -type f -exec dos2unix {} \;
find "$SCRIPTPATH/../" -type f -exec dos2unix {} \;
...
find "$SCRIPTPATH/../../../shared/" -type f -exec unix2dos {} \;
find "$SCRIPTPATH/../" -type f -exec unix2dos {} \;
