...
find "$tempShared" -regextype egrep -iregex ".*vim.*" -type f -exec sed -i'' "s,VIM_PLUGIN_IMPORT_CTRLP_PLACEHOLDER,$vim_plugin_import_ctrlp,g" {} \;
vim_plugin_import_rip_grep="Plugin 'jremmen/vim-ripgrep' \" grepper";
find "$tempShared" -regextype egrep -iregex ".*vim.*" -type f -exec sed -i'' "s,VIM_PLUGIN_IMPORT_RIP_GREP_PLACEHOLDER,$vim_plugin_import_rip_grep,g" {} \;
vim_plugin_import_quickfix="Plugin 'stefandtw/quickfix-reflector.vim' \" editable quickfix list for ripgrep";
find "$tempShared" -regextype egrep -iregex ".*vim.*" -type f -exec sed -i'' "s,VIM_PLUGIN_IMPORT_QUICKFIX_PLACEHOLDER,$vim_plugin_import_quickfix,g" {} \;
vim_plugin_import_fzf="\"Plugin 'junegunn/fzf'\, { 'do': { -> fzf#install() } }\nPlugin 'junegunn/fzf.vim'\nPlugin 'airblade/vim-rooter'\n";
find "$tempShared" -regextype egrep -iregex ".*vim.*" -type f -exec sed -i'' "s,VIM_PLUGIN_IMPORT_FZF_PLACEHOLDER,$vim_plugin_import_fzf,g" {} \;
vim_plugin_settings_ctrlp="so ~/vimfiles/plugin-settings/ctrlp.vim";
find "$tempShared" -regextype egrep -iregex ".*vim.*" -type f -exec sed -i'' "s,VIM_PLUGIN_SETTINGS_CTRLP_PLACEHOLDER,$vim_plugin_settings_ctrlp,g" {} \;
vim_plugin_settings_rip_grep="so ~/vimfiles/plugin-settings/ripgrep.vim";
find "$tempShared" -regextype egrep -iregex ".*vim.*" -type f -exec sed -i'' "s,VIM_PLUGIN_SETTINGS_RIP_GREP_PLACEHOLDER,$vim_plugin_settings_rip_grep,g" {} \;
vim_plugin_settings_quickfix="so ~/vimfiles/plugin-settings/quickfix-reflector.vim";
find "$tempShared" -regextype egrep -iregex ".*vim.*" -type f -exec sed -i'' "s,VIM_PLUGIN_SETTINGS_QUICKFIX_PLACEHOLDER,$vim_plugin_settings_quickfix,g" {} \;
vim_plugin_settings_fzf="\"so ~/vimfiles/plugin-settings/fzf.vim";
find "$tempShared" -regextype egrep -iregex ".*vim.*" -type f -exec sed -i'' "s,VIM_PLUGIN_SETTINGS_FZF_PLACEHOLDER,$vim_plugin_settings_fzf,g" {} \;
