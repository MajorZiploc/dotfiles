...
lvim.lsp.buffer_mappings.normal_mode['<leader>gi'] = { "<CMD>Telescope lsp_implementations<CR>", "Go to implementations" }
...
lvim.plugins = {
  ...
  { 'stefandtw/quickfix-reflector.vim' },  -- editable quickfix
...
vim.cmd('source ~/.vim/plugin-settings/cscopes_vim.vim')
