...
local function get_no_wallpaper()
	return {
    source = {
      Gradient = {
...
if appearance:find("Dark") then
  ...
  -- {
  --   source = {
  --     File = os.getenv("HOME") .. "/Pictures/Wallpapers/church_flowers_girl_kneel_guy_stand_side_shot.jpg",
  --   },
  ...
  -- },
		get_wallpaper(), -- background
		-- get_no_wallpaper(), -- no_background
		-- {
...
-- settings to fix option key on mac
