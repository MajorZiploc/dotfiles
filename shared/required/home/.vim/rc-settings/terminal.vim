...
command! -nargs=+ GFindFilesP call MyFinder('gfind_filesp', 'global', <f-args>)
...
command! -nargs=+ AFindFilesP call MyFinder('afind_filesp', 'global', <f-args>)
...
command! -nargs=+ FindFilesP call MyFinder('find_filesp',  'global', <f-args>)
...
command! -nargs=+ LGFindFilesP call MyFinder('gfind_filesp', 'local', <f-args>)
...
command! -nargs=+ LAFindFilesP call MyFinder('afind_filesp', 'local', <f-args>)
...
command! -nargs=+ LFindFilesP call MyFinder('file_filesp', 'local', <f-args>)
...
command! -nargs=+ GFindInFilesP call MyFinder('gfind_in_filesp', 'global', <f-args>)
...
command! -nargs=+ AFindInFilesP call MyFinder('afind_in_filesp', 'global', <f-args>)
...
command! -nargs=+ FindInFilesP call MyFinder('find_in_filesp', 'global', <f-args>)
...
command! -nargs=+ LGFindInFilesP call MyFinder('gfind_in_filesp', 'local', <f-args>)
...
command! -nargs=+ LAFindInFilesP call MyFinder('afind_in_filesp', 'local', <f-args>)
...
command! -nargs=+ LFindInFilesP call MyFinder('find_in_filesp', 'local', <f-args>)
command! -nargs=+ LFindInFilesFuzz call MyFinder('find_in_files_fuzz', 'local', <f-args>)

nmap <leader>dp :GFindFilesP "" ""
nmap <leader>da :GFindInFilesP "" ""
